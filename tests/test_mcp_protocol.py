...
class TestMCPProtocol:
    ...
    @pytest.mark.asyncio
    async def test_mcp_streamable_http_headers(self, http_client, wait_for_services):
    ...
    @pytest.mark.asyncio
    async def test_mcp_session_management(self, http_client, wait_for_services):
    ...
    @pytest.mark.asyncio
    async def test_mcp_protocol_version(self, http_client, wait_for_services):
    ...
    @pytest.mark.asyncio 
    async def test_mcp_batch_request_support(self, http_client, wait_for_services):
    ...
    @pytest.mark.asyncio
    async def test_mcp_http_methods(self, http_client, wait_for_services):
