...
@pytest.fixture
def time_url(base_domain):
    """Full URL for time service."""
    return f"https://mcp-time.{base_domain}/mcp"
...
class TestMCPTimeComprehensive:
    ...
    @pytest.mark.asyncio
    async def test_time_tool_discovery(self, time_url, client_token, wait_for_services):
    ...
    @pytest.mark.integration
    @pytest.mark.asyncio
    async def test_get_current_time_utc(self, time_url, client_token, wait_for_services):
    ...
    @pytest.mark.integration
    @pytest.mark.asyncio
    async def test_get_current_time_major_timezones(self, time_url, client_token, wait_for_services):
    ...
    @pytest.mark.integration
    @pytest.mark.asyncio
    async def test_convert_time_basic(self, time_url, client_token, wait_for_services):
    ...
    @pytest.mark.integration
    @pytest.mark.asyncio
    async def test_convert_time_global_business_hours(self, time_url, client_token, wait_for_services):
    ...
    @pytest.mark.integration
    @pytest.mark.asyncio
    async def test_convert_time_edge_cases(self, time_url, client_token, wait_for_services):
    ...
    @pytest.mark.integration
    @pytest.mark.asyncio
    async def test_time_error_handling(self, time_url, client_token, wait_for_services):
    ...
    @pytest.mark.integration
    @pytest.mark.asyncio
    async def test_time_timezone_detection(self, time_url, client_token, wait_for_services):
    ...
    @pytest.mark.integration
    @pytest.mark.asyncio
    async def test_time_complete_workflow(self, time_url, client_token, wait_for_services):
    ...
    @pytest.mark.integration
    @pytest.mark.asyncio
    async def test_time_protocol_compliance(self, time_url, client_token, wait_for_services):
    ...
    @pytest.mark.integration
    @pytest.mark.asyncio
    async def test_time_performance_batch(self, time_url, client_token, wait_for_services):
