...
class StreamableHTTPTransport:
    ...
    async def handle_request(self, method: str, path: str, headers: dict[str, str], body: bytes | None) -> tuple[int, dict[str, str], bytes]:
    ...
    async def _handle_post_request(self, headers: dict[str, str], body: bytes, session_id: str | None) -> tuple[int, dict[str, str], bytes]:
    ...
    async def _handle_get_request(self, headers: dict[str, str], session_id: str | None) -> tuple[int, dict[str, str], bytes]:
